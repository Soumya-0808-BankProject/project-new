    ...
    <Container maxWidth="xl" sx={{ px: 5, py: 3 }}>
      <Box container sx={{ mt: 2, mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          A <strong>personal loan</strong> is an unsecured loan offered by banks
          and financial institutions to individuals for personal use, such as
          medical expenses, home renovation, debt consolidation, travel, or
          education.
        </Typography>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <Typography variant="body1">
              <strong>Fixed Loan Amount:</strong> Typically between $1,000 and
              $50,000.
            </Typography>
          </Grid>
          <Grid item xs={12} sm={6}>
          ...
          <Grid item xs={12} sm={6}>
            <Typography variant="body1">
              <strong>Fixed Interest Rate:</strong> Often ranges from 8% to 18%
              annually.
            </Typography>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Typography variant="body1">
              <strong>Quick Disbursal:</strong> Funds often released within a
              few days.
            </Typography>
          </Grid>
        </Grid>
